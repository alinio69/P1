...
<br />
<fieldset style="width: 400px"><legend><img
	src="../img/admin/tab-customers.gif" />{$payment_name}</legend>

<p style="color: red; font-weight: bold;">{l s='The disposition state is
invalid' mod='cahsticket'} ({$disposition_state}) {l s='. You are not
allowed to perform the payment.' mod='cashticket'}</p>
</fieldset>
