...
<p>{l s='Your order on' mod='cashticket'} <span class="bold">{$shop_name}</span>
{l s='is complete.' mod='cashticket'} <br />
<br />
{l s='You have chosen the' mod='cashticket'} {$payment_name} {l
s='method.' mod='cashticket'} <br />
<br />
<span class="bold">{l s='Your order will be sent very soon.'
mod='cashticket'}</span> <br />
<br />
{l s='For any questions or for further information, please contact our'
mod='cashticket'} <a href="{$base_dir_ssl}contact-form.php">{l
s='customer support' mod='cashticket'}</a>.</p>
