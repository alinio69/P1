...
<p class="payment_module"><a href="modules/{$module_name}/redirect.php"
	title=""> <img src="{$pic_url}" alt="" width="86" height="49" /> {l
s='Pay with' mod='cashticket'} {$payment_name} </a></p>
