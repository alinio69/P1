...
* @copyright 2007-2011 PrestaShop SA * @version Release: $Revision: 6891
...
PrestaShop SA *} {if $datesDelivery|count}
...
<br />
<p id="dateofdelivery">{l s='Approximate date of delivery with this
carrier is between' mod='dateofdelivery'} <span id="minimal"></span> {l
s='and' mod='dateofdelivery'} <span id="maximal"></span> <sup>*</sup></p>
<p style="font-size: 10px; margin: 0padding : 0;"><sup>*</sup> {l
s='with direct payment methods (e.g: credit card)' mod='dateofdelivery'}</p>
{/if}
