...
<p id="dateofdelivery">{l s='Approximate date of delivery is between'
mod='dateofdelivery'} <b>{$datesDelivery.0}</b> {l s='and'
mod='dateofdelivery'} <b>{$datesDelivery.1}</b> <sup>*</sup></p>
